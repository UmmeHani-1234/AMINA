...
const MissionFeed = ({ current }) => <div className="mission-feed" role="img" aria-label="Simulated live mission view with AMINA rover moving across a planetary surface and CubeSat orbiting above">
