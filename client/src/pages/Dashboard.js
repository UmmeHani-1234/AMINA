  ...
  return <Appear id="dashboard" animate show={entered}>
    <div className="dashboard-shell">
      ...
      <section className="metric-strip" aria-label="Mission summary">
        ...
        <div><span>ROVER STATE</span><strong className={current.status === "NOMINAL" ? "good" : "warn"}>{current.status}</strong><small>AMINA ROVER · 04:18:22 UPTIME</small></div>
        <div><span>ACTIVE TARGET</span><strong>TARGET #{selected.id}</strong><small>{selected.name} · {selected.distance} m</small></div>
        ...
        <div className="panel map-panel">
          ...
          <div className="terrain-map">
            ...
            <svg viewBox="0 0 700 330" role="img" aria-label="Simulated terrain map with rover route and target">
              ...
              <circle className="rover-point" cx="88" cy="248" r="8" /><circle className="target-point" cx="618" cy="84" r="10" /><circle className="hazard-point" cx="390" cy="132" r={current.hazard ? 24 : 0} />
