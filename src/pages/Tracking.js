...
const RoverVisual = memo(() => {
  return <div style={{ position: "relative", width: "100%", minHeight: "195px", background: "#000" }}>
    <video autoPlay muted loop playsInline preload="metadata" style={{ display: "block", width: "100%", height: "100%", minHeight: "195px", objectFit: "cover" }}>
...
const SatelliteVisual = memo(() => {
  return <div style={{ position: "relative", width: "100%", height: "100%", minHeight: "390px", background: "#000" }}>
    <video autoPlay muted loop playsInline preload="metadata" style={{ display: "block", width: "100%", height: "100%", minHeight: "390px", objectFit: "cover" }}>
...
const Tracking = memo(({ entered, mode }) => {
